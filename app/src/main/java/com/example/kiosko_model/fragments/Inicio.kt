        ...
        try {
            ...
            viewModel.datos.observe(viewLifecycleOwner) { response ->
                ...
                if (response.isSuccessful) {
                    ...
                    val lpTextHardCodedTitle = LinearLayout.LayoutParams(
                    ...
                    val lpTextHardCodedSubTitle = LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.WRAP_CONTENT
                    )
                    ...
                    val lpTextHardCodedProgres = LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.WRAP_CONTENT
                    )
...
//
                            ...
                            val lpProgreso = LinearLayout.LayoutParams(
                                LinearLayout.LayoutParams.MATCH_PARENT,
                                LinearLayout.LayoutParams.WRAP_CONTENT
                            )
                            lpProgreso.setMargins(20, 0, 20, 0)

                            val lpProgresoTitulo = LinearLayout.LayoutParams(
                                LinearLayout.LayoutParams.MATCH_PARENT,
                                LinearLayout.LayoutParams.WRAP_CONTENT
                            )
                            lpProgresoTitulo.setMargins(30, 10, 40, 15)

                            val lpProgresoPorcentaje = LinearLayout.LayoutParams(
                                LinearLayout.LayoutParams.MATCH_PARENT,
                                LinearLayout.LayoutParams.WRAP_CONTENT
                            )
                            lpProgresoPorcentaje.setMargins(30, 10, 40, 10)

                            val lpProgresoContenedor = LinearLayout.LayoutParams(
                                LinearLayout.LayoutParams.MATCH_PARENT,
                                LinearLayout.LayoutParams.WRAP_CONTENT
                            )
                            lpProgresoContenedor.setMargins(20, 20, 30, 50)

                            val lpProgresoBotonContenedor = LinearLayout.LayoutParams(
                                LinearLayout.LayoutParams.WRAP_CONTENT,
                                LinearLayout.LayoutParams.WRAP_CONTENT
                            )
                            ...
                            val lpTituloBotonProgres = LinearLayout.LayoutParams(
                                LinearLayout.LayoutParams.MATCH_PARENT,
                                LinearLayout.LayoutParams.WRAP_CONTENT
                            )
...
//                                    contenedorBotonera.addView(tituloBotoneraProgres,lpProgresoBotonContenedor)
                            LinearHorizontalBotones.addView(
                                contenedorBotonera,
                                lpContenedorBotonera
                            )



                            contenedorBotonProgreso.addView(
                                botoneraHorizontalProgreso,
                                lpBotonProgreso
                            )
//                                    contenedorBotonProgreso.addView(tituloBotonProgres,lpProgresoBotonContenedor)
                        ...
                        } else if (it.desplegable == 1 && it.padre == null && it.submodulos!!.isNotEmpty()) {
...
//
                            ...
                            botoneraHorizontalProgreso.setOnClickListener {
                                ...
                                porcentajeViewModel.setProgresoPorModulo(100)
                                val progresoPModulo =
                                    porcentajeViewModel.progresoPerModulo.value
                                val progreso = porcentajeViewModel.porcentaje.value
                                porcentajeViewModel.setPorcentaje(progreso!! + progresoPModulo!!)
                                llBotoneraConProgreso.removeAllViews()
                                llBotonera.removeAllViews()
...
//                                    contenedorBotonProgreso.addView(tituloBotonProgres,lpProgresoBotonContenedor)
                            ...
                            contenedorProgresoScroll.addView(
                                linearLayout,
                                lpTituloBotonProgres
                            )
                        } else if (it.submodulos!!.isNotEmpty()) {
                            //    Log.d("Inicio3", response.body()?.customModulos!!.toString())
                            val idModulo = it.id
                            val hijos = it.numeroHijos
...
//                                    contenedorBotonProgreso.addView(tituloBotonProgres,lpProgresoBotonContenedor)
                    ...
                    if (height > 1000 && width > 600) {
                        ...
                        if (height > 1400 && width > 1000) {
                            val height2 = 1300
                            scrollLP = LinearLayout.LayoutParams(
                                LinearLayout.LayoutParams.MATCH_PARENT,
                                height / 3
                            )
                    ...
                    val scrollLPContenedor = LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.MATCH_PARENT
                    )
...
//                Toast.makeText(context, "terminado", Toast.LENGTH_SHORT).show()
            ...
            avisoViewModel =
                ViewModelProvider(this, viewModelFactoryAviso)[MensajeInicialViewModel::class.java]
