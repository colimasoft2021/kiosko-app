...
import com.example.kiosko_model.models.Guias
import com.example.kiosko_model.models.GuiasContenidoViewModel
import com.example.kiosko_model.models.GuiasViewModel
import com.example.kiosko_model.models.GuiasViewModelFactory
...
//                responseControlInterno = ControlInterno.toList()
                ...
                ListControlInternoAdapter =
                    GuiasAdapter(requireContext(), ListControlInterno as List<ItemDataGuias>)
                ...
                ListEjecucionAdapter =
                    GuiasAdapter(requireContext(), ListEjecucion as List<ItemDataGuias>)
                ...
                ListAbastecimientoAdapter =
                    GuiasAdapter(requireContext(), ListAbastecimiento as List<ItemDataGuias>)
                ...
                ListSeguridadAdapter =
                    GuiasAdapter(requireContext(), ListSeguridad as List<ItemDataGuias>)
                ...
                ListServicioAdapter =
                    GuiasAdapter(requireContext(), ListServicio as List<ItemDataGuias>)
                ...
                ListInstrucAdapter =
                    GuiasAdapter(requireContext(), ListInstructivos as List<ItemDataGuias>)
    ...
    override fun onItemClick(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
        ...
        val controlInterno = 2131361801
        val ejecucion = 2131361802
        val abastecimiento = 2131361800
        val seguridad = 2131361803
        val servicio = 2131361804
        val instructivos = 2131361799
        ...
        when (p0?.id) {
            ...
            ejecucion -> {
                ...
                viewModel2.colorModuloGuias(ColorFondoresponseEjecucion?.get(p2))
                viewModel2.componentes(item.componentes!!)
                findNavController().navigate(R.id.action_guiasFragment_to_guiasContenido)
            }
            abastecimiento -> {
                ...
                viewModel2.colorModuloGuias(ColorFondoresponseAbastecimiento?.get(p2))
                viewModel2.componentes(item.componentes!!)
                findNavController().navigate(R.id.action_guiasFragment_to_guiasContenido)
            }
            seguridad -> {
                ...
                viewModel2.colorModuloGuias(ColorFondoresponseSeguridad?.get(p2))
                viewModel2.componentes(item.componentes!!)
                findNavController().navigate(R.id.action_guiasFragment_to_guiasContenido)
            }
            servicio -> {
                ...
                viewModel2.colorModuloGuias(ColorFondoresponseServicio?.get(p2))
                viewModel2.componentes(item.componentes!!)
                findNavController().navigate(R.id.action_guiasFragment_to_guiasContenido)
